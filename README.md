...
Keep is a focused project in this monorepo that delivers a practical tool with a clean user experience across platforms.

## ✨ 2. Features

1. [x] Core functionality tailored to Keep
...
- 🌐 [Live Demo](https://hieudoanm.github.io/keep/)

## 🚀 4. Usage

- 🌐 [Web](https://hieudoanm.github.io/keep/)
